...
<a href="<?php echo e(url('/analytics')); ?>">Reason for Dropout</a>
...
<script type="text/javascript">
	...
	// Themes begin
		...
		function load_partner_dropout_chart(gender,form_filter,category_filter,nationlity_filter,governorate_filter,partner_filter)
		{
			...
			$.post('<?php echo e(route('load-partner-dropout')); ?>',{_token:"<?php echo e(csrf_token()); ?>",gender:gender,form_filter:form_filter,category_filter:category_filter,nationlity_filter:nationlity_filter,governorate_filter:governorate_filter,partner_filter:partner_filter},function(response){
			...
			// Add data
		$.post('<?php echo e(route('load-reason-for-dropout')); ?>',{_token:"<?php echo e(csrf_token()); ?>",gender:gender,form_filter:form_filter,category_filter:category_filter,nationlity_filter:nationlity_filter,governorate_filter:governorate_filter,partner_filter:partner_filter},function(response){
		...
		// Add data
		// $.post('<?php echo e(route('load-reason-for-dropout')); ?>',{_token:"<?php echo e(csrf_token()); ?>"},function(response){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hqpyj8xflnii/public_html/prod/resources/views/admin/reports/reason_for_dropout.blade.php ENDPATH**/ ?>