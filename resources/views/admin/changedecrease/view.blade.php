...
<!-- A- Emotional scale -->
							...
							<tr>
								...
								<td><strong>@if(isset($data['pre_test']['emotional_scale'])) {{ $data['pre_test']['emotional_scale'] }} @endif</strong></td>
								<td><strong>@if(isset($data['post_test']['emotional_scale'])) {{ $data['post_test']['emotional_scale'] }} @endif</strong></td>
							</tr>
							<tr>
								<td>---</td>								
								<td>---</td>
...
<!-- B- Conduct scale -->
							...
							<tr>
								...
								<td><strong>@if(isset($data['pre_test']['conduct_scale'])) {{ $data['pre_test']['conduct_scale'] }} @endif</strong></td>
								<td><strong>@if(isset($data['post_test']['conduct_scale'])) {{ $data['post_test']['conduct_scale'] }} @endif</strong></td>
							</tr>
							<tr>
								<td>---</td>								
								<td>---</td>
...
<!-- C- Hyperactivity scale -->
							...
							<tr>
								...
								<td><strong>@if(isset($data['pre_test']['hyper_activity_scale'])) {{ $data['pre_test']['hyper_activity_scale'] }} @endif</strong></td>
								<td><strong>@if(isset($data['post_test']['hyper_activity_scale'])) {{ $data['post_test']['hyper_activity_scale'] }} @endif</strong></td>
							</tr>
							<tr>
								<td>---</td>								
								<td>---</td>
...
<!-- D- Peer problems scale -->
							...
							<tr>
								...
								<td><strong>@if(isset($data['pre_test']['peer_problem_scale'])) {{ $data['pre_test']['peer_problem_scale'] }} @endif</strong></td>
								<td><strong>@if(isset($data['post_test']['peer_problem_scale'])) {{ $data['post_test']['peer_problem_scale'] }} @endif</strong></td>
							</tr>
							<tr>
								<td>---</td>								
								<td>---</td>
...
<!-- E- Pro social scale -->
							...
							<tr>
								...
								<td><strong>@if(isset($data['pre_test']['pro_social_scale'])) {{ $data['pre_test']['pro_social_scale'] }} @endif</strong></td>
								<td><strong>@if(isset($data['post_test']['pro_social_scale'])) {{ $data['post_test']['pro_social_scale'] }} @endif</strong></td>
							</tr>
